...
```bash
git clone https://github.com/LayerTsuchikageBound/humanize-ppt-987.git
cd humanize-ppt-987
python setup.py
```
...
```text
https://github.com/LayerTsuchikageBound/humanize-ppt-987
...
```bash
npx skills add https://github.com/LayerTsuchikageBound/humanize-ppt-987.git -g -y
```
...
<!-- Last updated: 2026-06-06 15:16:39 -->
